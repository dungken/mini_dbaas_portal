...
export default function UserInfoCard() {
  ...
  const displayFirstName = userData?.first_name || userData?.name?.split(" ")[0] || "User";
  const displayLastName = userData?.last_name || userData?.name?.split(" ").slice(1).join(" ") || "";
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {loading ? "Loading..." : displayLastName || "-"}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {loading ? "Loading..." : userData?.phone || "-"}
              </p>
            </div>
